    ...
    return (
        <section className="section-plugins">
            ...
            <div className="container">
                ...
                <h2 className="container__slogan">Build your <span className="slogan_colored">digital studio</span></h2>
                <p className="container__text">Try industry-leading music software for free? pay it off over time and own it
                    forever.</p>
